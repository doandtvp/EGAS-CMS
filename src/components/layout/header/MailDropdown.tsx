          ...
          <div key={item} className="px-5 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/40 cursor-pointer transition-colors flex gap-4 border-b border-gray-50 dark:border-gray-700/50 last:border-0 relative">
            ...
            <div className="flex-grow min-w-0">
              <div className="flex items-center justify-between mb-0.5 mt-0.5">
                <p className="text-sm font-bold text-gray-800 dark:text-gray-200 truncate pr-4">Bảo trì hệ thống CHXD ngày 15/12</p>
                {item === 1 && <div className="absolute right-5 top-8 w-2 h-2 bg-blue-500 rounded-full shadow-[0_0_8px_rgba(59,130,246,0.5)]"></div>}
              </div>
