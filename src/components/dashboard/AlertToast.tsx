...
const AlertToast: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[100] w-[calc(100vw-32px)] sm:max-w-[420px] animate-in fade-in slide-in-from-right-10 duration-500">
      <div className="relative bg-white border-2 border-[#FF3B3B] rounded-xl shadow-[0_10px_50px_-12px_rgba(239,68,68,0.15)] p-4 sm:p-5">
        {/* Floating Alert Icon */}
        ...
        <div className="space-y-4 pr-6 pt-1">
          ...
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 rounded-full bg-[#FEF2F2] flex items-center justify-center flex-shrink-0 text-[#EF4444]">
              <GasStationIcon className="w-6 h-6" />
            </div>
            <div className="flex-1 flex items-center justify-between">
              <span className="text-[12px] font-bold text-gray-700 leading-tight">
                Bồn RON95 còn dưới 10%
              </span>
              <button className="text-[11px] font-bold text-[#F97316] hover:underline whitespace-nowrap ml-4">
                Xem chi tiết
              </button>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between">
                <span className="text-[12px] font-bold text-gray-700 leading-tight">
                  Khách công nợ Công ty TNHH Tuấn Việt sắp đến hạn thu nợ
                </span>
                <button className="text-[11px] font-bold text-[#F97316] hover:underline whitespace-nowrap ml-4 mt-2">
                  Thu nợ
                </button>
              </div>
            </div>
